...
# Zapret Discord Youtube 19.9.0

### YouTube Unban · Discord connecting / RTC · обход DPI без VPN

**[pillarchiefproceed/zapret-discord-youtube-19.9.0](https://github.com/pillarchiefproceed/zapret-discord-youtube-19.9.0)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/pillarchiefproceed/zapret-discord-youtube-19.9.0/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `pillarchiefproceed/zapret-discord-youtube-19.9.0`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/pillarchiefproceed/zapret-discord-youtube-19.9.0/releases/latest) и скачайте **`.rar`** (предпочтительно)
